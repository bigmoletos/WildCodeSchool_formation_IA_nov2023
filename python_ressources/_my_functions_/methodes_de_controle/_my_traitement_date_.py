...
def between_2dates(date1, date2):
...
jours = between_2dates('13-10-2023', '20-10-2023')
print("Il y a ", jours, " jours entre ces deux dates.")


def between_hours(heure1, heure2):
...
# Exemple d'utilisation :
print(between_hours('12:34:56.789012', '13:14:15.161718'))
